       ...
       <footer>
         <div className="piepag">
          ...
          <div className="columna3">
            ...
            <div className="row">
              <label><i className="bi bi-envelope-open"></i> jessica2171736@correo.uis.edu.co</label>
            </div>
            <div className="row">
              <label><i className="bi bi-envelope-open"></i> luis2190087@correo.uis.edu.co</label>
            </div>
            <div className="row">
              <label><i className="bi bi-envelope-open"></i> brandon2190078@correo.uis.edu.co</label>
            </div>
